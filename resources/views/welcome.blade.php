        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <img src="{{ asset('assets/client/logo-mathx.png') }}" class="img-fluid">
                </div>
                <div class="col-md-9 col-sm-6">
                    <div class="m-5 text-justify">
                        <h3 class="m-auto"><strong>Dịch vụ MathX - </strong>Chương trình học toán online dành cho học sinh Tiểu học và Trung
                            học cơ sở với kho bài giảng, bài luyện tập phong phú từ cơ bản đến nâng cao
                            nhằm mang đến cho học sinh những bài học sinh động, lý thú giúp các em vững
                            vàng kiến thức, say mê và yêu thích môn toán.</h3>
                    </div>
                </div>
            </div>
