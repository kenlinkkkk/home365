    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home.index') }}">
                <img src="{{ asset('assets/client/logo-mathx.png') }}" width="100" alt="header logo" class="img-fluid">
            </a>
...
{{--                                <a href="{{ route('home.showProfile') }}" class="dropdown-item m-2 text-white">Thông tin cá nhân</a>--}}
                    ...
                    @if(session()->get('_user')['msisdn'] == 'empty' || empty(session()->get('_user')['msisdn']))
                            <li class="nav-item"><a href="https://mathx.vn/dang-nhap.html" class="nav-link"><span>Đăng nhập</span></a></li>
                    @endif
                </ul>
            </div>
        </div>
